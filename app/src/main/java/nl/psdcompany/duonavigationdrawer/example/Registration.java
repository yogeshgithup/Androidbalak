...
public class Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mt2.execute("http://192.168.1.57:8084/GETSWEB/SerCourseSpinner");
...
//
                ...
                mt1.execute("http://192.168.1.57:8084/GETSWEB/SerPersonAndroid",ab.toString());
        ...
        //  Toast.makeText(Registration.this, output, Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                for (int i = 0; i < jb.length(); i++) {
                    ...
                    String c_name = ob.getString("c_name");
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter(Registration.this, android.R.layout.simple_spinner_item, list);
