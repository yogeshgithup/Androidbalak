...
public class Working_Schedule extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.working_schedule, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Working Schedule");
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for(int i=0;i<ja.length();i++) {
                    ...
                    View tableRow =LayoutInflater.from(getContext()).inflate(R.layout.working_schedule_item,null,false);
