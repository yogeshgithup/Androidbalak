...
public class StudentEmail extends AppCompatActivity {
    TextView tvst1,tvst2,tvst3,tvst4;


    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.studentemail);
        tvst1 = (TextView) findViewById(R.id.tvst1);
        tvst2 = (TextView) findViewById(R.id.tvst2);
        tvst3 = (TextView) findViewById(R.id.tvst3);
        tvst4 = (TextView) findViewById(R.id.tvst4);
        //    String username;
        String n;
        Intent intent;
        intent=getIntent();
        ...
        mt1.execute("http://192.168.43.112:8080/GETSWEB/SerDetailsAndroid",ab.toString());
    ...
    private class MyTask1 extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String output) {
            ...
            try {
                ...
                tvst1.setText(obj.getString("f_name"));
                tvst2.setText(obj.getString("contact_no"));
                tvst3.setText(obj.getString("email"));
                tvst4.setText(obj.getString("address"));
        ...
        protected void onPreExecute() {
            pd=new ProgressDialog(StudentEmail.this);
