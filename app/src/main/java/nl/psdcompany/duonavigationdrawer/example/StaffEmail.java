...
public class StaffEmail extends AppCompatActivity {
    TextView tvs1,tvs2,tvs3,tvs4;
    ...
    private class MyTask1 extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String output) {
            ...
            try {
                ...
                tvs1.setText(obj.getString("f_name"));
                tvs2.setText(obj.getString("contact_no"));
                tvs3.setText(obj.getString("email"));
                tvs4.setText(obj.getString("address"));
        ...
        protected void onPreExecute() {
            pd=new ProgressDialog(StaffEmail.this);
