...
public class Report extends Fragment {
    ...
    private ArrayList<pojo_report> datalist;
    String url="http://192.168.1.27:8080/GETSWEB/SerAndroidMarks";

    TableLayout tableLayout;

    TextView subject,title,total,marks;
    String n;
    Intent intent;
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for(int i=0;i<ja.length();i++) {
                    ...
                    String title=obj.getString("exam_title");

                    String total=obj.getString("total_marks");

                    String marks=obj.getString("obtained_marks");

                    Log.d("167line",LayoutInflater.from(getContext())+"");
                    View tableRow =LayoutInflater.from(getContext()).inflate(R.layout.student_report_item,null,false);

                    TextView markss  = (TextView)tableRow.findViewById(R.id.marks);
                    TextView subjectt= (TextView)tableRow.findViewById(R.id.subject);
                    TextView titlee= (TextView)tableRow.findViewById(R.id.title);
                    TextView totall= (TextView)tableRow.findViewById(R.id.total);
